...
export default function PipelinePage() {
  ...
  if (pipelinesError) {
    return (
      <div className="flex-1 w-full flex items-center justify-center">
        <div className="text-red-500">Failed to load pipelines</div>
      </div>
    );
  }
  ...
  if (pipelinesLoading) {
    return (
      <div className="flex-1 w-full flex items-center justify-center">
        <div className="animate-pulse text-lg">Loading pipelines...</div>
      </div>
    );
  }
    ...
    <div className="flex-1 w-full p-6">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold bg-gradient-to-r from-teal-600 to-cyan-500 bg-clip-text text-transparent">
          {fieldId ? "Field " : "All "}Pipelines
        </h1>
        <p className="text-muted-foreground mt-2">
          {filteredAndSortedPipelines.length} pipeline{filteredAndSortedPipelines.length !== 1 ? 's' : ''}
        </p>
      </div>
