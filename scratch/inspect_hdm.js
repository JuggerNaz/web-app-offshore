...
async function run() {
    try {
        const url = `${SUPABASE_URL}/rest/v1/structure_components?id=in.(131928,131895)&select=id,q_id,code,metadata`;
        const comps = await fetchJson(url);
        console.log("PARENT COMPONENTS FOR N44 & N47:");
