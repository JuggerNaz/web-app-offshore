...
import { Plus, Edit, Settings, ArrowLeft, ArrowRight, ChevronDown, Video, X } from "lucide-react";
        ...
        <>
          {createPortal(
            <div className="h-full w-full bg-black flex flex-col overflow-hidden select-none">
              ...
              <div className="flex-1 flex flex-col min-h-0 overflow-hidden">{renderStreamUI()}</div>
            </div>,
