...
async function run() {
    try {
        ...
        // Find WN N44 and WN N47
        const wn44 = rawComponents.find(c => c.q_id === 'WN N44');
        const wn47 = rawComponents.find(c => c.q_id === 'WN N47');
        const hom44_47 = rawComponents.find(c => c.q_id === 'HOM N44-N47');
        
        console.log("WN N44:", JSON.stringify(wn44, null, 2));
        console.log("WN N47:", JSON.stringify(wn47, null, 2));
        console.log("HOM N44-N47:", JSON.stringify(hom44_47, null, 2));
    } catch (err) {
        console.error(err);
    }
}
