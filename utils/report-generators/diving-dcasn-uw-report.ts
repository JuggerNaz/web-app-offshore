...
/**
 * Diving Caisson Underwater Report (Portrait)
...
export const generateDivingDCASNUWReport = async (
    ...
    console.log("[Diving Caisson UW Report] Starting generation", { recordsCount: records?.length, config });
    ...
    try {
        ...
        const drawPageHeader = (d: jsPDF) => {
            ...
            d.setFontSize(11); d.setFont("helvetica", "bold");
            d.text("Caisson Inspection Underwater Diving", margin + (contentWidth / 2), margin + 16.5, { align: "center" });
        ...
        console.log("[Diving Caisson UW Report] Generation complete, returnBlob:", config?.returnBlob);
