        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[600px] bg-white border-slate-200 shadow-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 py-1">
                    ...
                    <div className="grid grid-cols-1 pb-2 border-b border-slate-50">
                        <div className="space-y-1">
                            <Label htmlFor="type" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                Category / Type <span className="text-red-500">*</span>
                            </Label>
                            <Select value={formData.code} onValueChange={handleTypeChange}>
                                <SelectTrigger className="h-10 text-sm font-bold bg-blue-50/50 border-blue-100 focus:ring-blue-500/20">
                                    <SelectValue placeholder="Select Category" />
                                </SelectTrigger>
                                <SelectContent>
                                    {filteredCompTypes.map((c: any) => (
                                        <SelectItem key={c.code} value={c.code} className="font-bold text-xs uppercase text-slate-700">
                                            {c.descrip || c.name}
                                        </SelectItem>
                                    ))}
                                </SelectContent>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        <div className="space-y-1">
                            <div className="flex justify-between items-end mb-1">
                                <Label htmlFor="q_id" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                        ...
                        <div className="space-y-1">
                            <Label htmlFor="description" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                Description
                            </Label>
                            <Input
                                id="description"
                        ...
                        <div className="space-y-1">
                            <Label htmlFor="code" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                Code
                            </Label>
                            <Input
                                id="code"
                                ...
                                readOnly
                                placeholder="AN"
                                className="h-9 text-xs font-bold bg-slate-100 border-slate-200 text-slate-500 cursor-not-allowed"
                            />
                        </div>
                    </div>
                    ...
                    {structureType === "platform" ? (
                        <>
                            <div className="grid grid-cols-3 gap-3">
                                <div className="space-y-1">
                                    <Label htmlFor="f_node" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                        Start Node
                                    </Label>
                                    <Input
                                        id="f_node"
                                ...
                                <div className="space-y-1">
                                    <Label htmlFor="f_leg" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                        Start Leg
                                    </Label>
                                    {legOptions.length > 0 ? (
                                ...
                                <div className="space-y-1">
                                    <Label htmlFor="elv_1" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                        Elevation 1
                                    </Label>
                                    <div className="flex gap-1">
                                        ...
                                        <Select value={formData.elv_1_unit} onValueChange={(v) => setFormData({...formData, elv_1_unit: v})}>
                                            <SelectTrigger className="h-9 w-[60px] text-[10px] font-black bg-slate-100 border-slate-200 lowercase">
                                                <SelectValue />
                                            </SelectTrigger>
                                            <SelectContent>
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                <div className="space-y-1">
                                    <Label htmlFor="s_node" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                        End Node
                                    </Label>
                                    <Input
                                        id="s_node"
                                ...
                                <div className="space-y-1">
                                    <Label htmlFor="s_leg" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                        End Leg
                                    </Label>
                                    {legOptions.length > 0 ? (
                                ...
                                <div className="space-y-1">
                                    <Label htmlFor="elv_2" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                        Elevation 2
                                    </Label>
                                    <div className="flex gap-1">
                                        <Input
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            <div className="space-y-1">
                                <Label htmlFor="kp" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                    KP
                                </Label>
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        placeholder="0.000"
                                        className="pl-8 h-9 text-xs font-bold bg-slate-50 border-slate-200"
                                    />
                                </div>
                            </div>
                            <div className="space-y-1">
                                <Label htmlFor="x_cord" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                    Easting
                                </Label>
                                <div className="relative">
                            ...
                            <div className="space-y-1">
                                <Label htmlFor="y_cord" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                    Northing
                                </Label>
                                <div className="relative">
                                    <Navigation className="absolute left-2.5 top-1/2 -translate-y-1/2 w-3.5 h-3.5 text-slate-400 rotate-90" />
                                    <Input
                                        id="y_cord"
                    ...
                    <div className="grid grid-cols-4 gap-3">
                        <div className="space-y-1">
                            <Label htmlFor="clk_pos" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                Clock Position
                            </Label>
                            {clockOptions.length > 0 ? (
                                <Select value={formData.clk_pos} onValueChange={(v) => setFormData({...formData, clk_pos: v})}>
                                    ...
                                    <SelectContent>
                                        {clockOptions.map((opt: any) => (
                                            <SelectItem key={opt.value} value={opt.value} className="text-[11px] font-bold uppercase">{opt.label}</SelectItem>
                                        ))}
                                    </SelectContent>
                                </Select>
                            ) : (
                                <Input
                                    ...
                                    placeholder="12:00"
                                    className="h-9 text-[11px] font-bold bg-slate-50 border-slate-200"
                                />
                            )}
                        </div>
                        <div className="space-y-1">
                            <Label htmlFor="lvl" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                Level
                            </Label>
                        ...
                        <div className="space-y-1">
                            <Label htmlFor="face" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                Face
                            </Label>
                        ...
                        <div className="space-y-1">
                            <Label htmlFor="dist" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                Distance
                            </Label>
                            <div className="flex gap-1">
                                <Input
                                    ...
                                    placeholder="0.00"
                                    className="h-9 text-[11px] font-bold bg-slate-50 border-slate-200 flex-1"
                                />
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        <div className="space-y-1">
                            <Label htmlFor="top_und" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                Top / Und
                            </Label>
                            <Select value={formData.top_und} onValueChange={(v) => setFormData({...formData, top_und: v})}>
                                ...
                                <SelectContent>
                                    <SelectItem value="SUBSEA" className="text-[11px] font-bold">SUBSEA</SelectItem>
                                    <SelectItem value="ABOVE WATER" className="text-[11px] font-bold">ABOVE WATER</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                        <div className="col-span-2 space-y-1">
                            <Label htmlFor="comp_group" className="text-[10px] font-black uppercase text-slate-800 tracking-widest ml-1">
                                Structural Group
                            </Label>
