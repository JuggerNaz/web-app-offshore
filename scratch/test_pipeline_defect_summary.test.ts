...
async function runTest() {
    console.log("Testing generatePipelineDefectSummaryReport...");
    ...
    try {
        const pdfBlob = await generatePipelineDefectSummaryReport(
            sampleJobPack,
            sampleStructure,
            "SOW-2024-001",
            companySettings,
        ...
        console.log("Standard Report PDF Blob generated successfully. Size:", (pdfBlob as Blob).size, "bytes");

        // Test Blank Report mode
        const blankBlob = await generatePipelineDefectSummaryReport(
            sampleJobPack,
            sampleStructure,
            "SOW-2024-001",
            companySettings,
            { ...config, isBlankReport: true },
            []
        );

        console.log("Blank Report PDF Blob generated successfully. Size:", (blankBlob as Blob).size, "bytes");
        console.log("ALL PDF GENERATION TESTS PASSED CLEANLY!");
    } catch (err) {
