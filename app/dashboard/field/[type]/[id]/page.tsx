    ...
    <div className="flex-1 w-full flex flex-col gap-3">
      <Tabs defaultValue="spec1">
        <TabsList className="w-full">
          <TabsTrigger className="grow" value="spec1">
            Specification
          </TabsTrigger>
          <TabsTrigger className="grow" value="spec2" disabled={id === "new" ? true : false}>
            Specification 2
          </TabsTrigger>
          <TabsTrigger
            className="grow"
          ...
          <TabsTrigger className="grow" value="comments" disabled={id === "new" ? true : false}>
            Comments
          </TabsTrigger>
          <TabsTrigger className="grow" value="attachments" disabled={id === "new" ? true : false}>
            Attachment
          </TabsTrigger>
          <TabsTrigger className="grow" value="components" disabled={id === "new" ? true : false}>
            Components
          </TabsTrigger>
        </TabsList>
        <TabsContent value="spec1" className="py-2 px-1">
          <Suspense fallback={<Loading />}>
            {type === "platform" ? (
              <SpecHead data={id === "new" ? defaults : data?.data} />
            ) : (
              <Spec1Pipeline data={id === "new" ? pipelineDefaults : data?.data} />
            )}
          </Suspense>
        </TabsContent>
        ...
        <TabsContent value="structure-image">
          <Suspense fallback={<Loading />}>
            <StructureImage />
          </Suspense>
        </TabsContent>
