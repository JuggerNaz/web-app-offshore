...
export function ConditionalTemplatesTab({
    ...
    const standardVariables = [
        ...
        { key: "{{CLIENT_SHORT}}", desc: "Client Short Name" },
        { key: "{{CONTRACTOR_NAME}}", desc: "Contractor Full Name" },
        { key: "{{CONTRACTOR_SHORT}}", desc: "Contractor Short Name" },
        { key: "{{OIL_FIELD}}", desc: "Oil Field Name" },
        { key: "{{VESSEL_NAME}}", desc: "Vessels Involved" },
        { key: "{{DATE}}", desc: "Current Date" },
        { key: "{{TODAY_SHORT}}", desc: "Today Date (dd-Mon-yyyy)" },
