                            ...
                            <div className="space-y-6 pb-10">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <TagList items={[
                                        ...
                                        { tag: "{{TASK_TYPE}}", desc: "Job pack task type (e.g. STRUCTURE)" },
                                        { tag: "{{PLAN_TYPE}}", desc: "Job pack plan type (e.g. INSTANT)" },
                                        { tag: "{{INSPECTION_MODE}}", desc: "Inspection mode (e.g. ROV / AIR DIVING)" },
                                        { tag: "{{PROJECT_SCOPE}}", desc: "Project scope (e.g. Subsea)" },
                                        { tag: "{{COMPANY_REP}}", desc: "Company representative name" },
                                        { tag: "{{CONTRACT_REF}}", desc: "Contract reference number" },
                                        { tag: "{{CONTRACTOR_REF}}", desc: "Contractor reference number" },
                                        { tag: "{{CONTRACTOR_NAME}}", desc: "Contractor name from Job Pack metadata" },
                                        { tag: "{{CONTRACTOR_SHORT}}", desc: "Contractor short name / Library ID" },
                                        { tag: "{{CONTRACTOR_ADDRESS}}", desc: "Contractor address from Job Pack metadata" },
                                        { tag: "{%CONTRACTOR_LOGO}", desc: "Image tag for Contractor Logo" },
                                        { tag: "{{STATUS}}", desc: "Job pack status (e.g. OPEN)" },
                                        { tag: "{{SHORT_DATE}}", desc: "Short jobpack start date (e.g. Jun 2026)" },
                                        { tag: "{{TODAY_SHORT}}", desc: "Today's date in dd-Mon-yyyy format (e.g. 27-Jun-2026)" },
                                     ]} />
