...
export default function PlatformPage() {
  ...
  if (platformsError) {
    return (
      <div className="flex-1 w-full flex items-center justify-center">
        <div className="text-red-500">Failed to load platforms</div>
      </div>
    );
  }
  ...
  if (platformsLoading) {
    return (
      <div className="flex-1 w-full flex items-center justify-center">
        <div className="animate-pulse text-lg">Loading platforms...</div>
      </div>
    );
  }
    ...
    <div className="flex-1 w-full p-6">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-500 bg-clip-text text-transparent">
          {fieldId ? "Field " : "All "}Platforms
        </h1>
        <p className="text-muted-foreground mt-2">
          {filteredAndSortedPlatforms.length} platform{filteredAndSortedPlatforms.length !== 1 ? 's' : ''}
        </p>
      </div>
