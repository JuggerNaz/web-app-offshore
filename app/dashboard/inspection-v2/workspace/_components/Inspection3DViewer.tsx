...
import { OrbitControls, PerspectiveCamera, Grid, Html, ContactShadows, Edges } from "@react-three/drei";
    ...
    return (
        <div className="w-full h-full bg-blue-50 relative rounded-lg overflow-hidden border border-blue-100 shadow-inner">
            ...
            <div className="absolute bottom-4 left-4 flex flex-col gap-1 pointer-events-none">
                <span className="text-[10px] font-black uppercase tracking-widest text-blue-900/40">3D Navigation</span>
                <span className="text-[9px] text-blue-800/50 font-bold">Rotate: Left Click | Pan: Right Click | Zoom: Scroll</span>
            </div>
            ...
            <div className="absolute top-4 right-4 bg-white/80 backdrop-blur px-3 py-1.5 rounded-full border border-blue-100 pointer-events-none flex items-center gap-2 shadow-sm">
                ...
                <span className="text-[11px] font-black text-blue-900 uppercase tracking-tight">{allComponents.length} Structures Mapped</span>
            </div>
        </div>
    );
}
